...
class CharRelation extends React.Component {
	render() {
				...
				<div key={key} className='rel-prnt'>
					...
					{relation.type === "character" && (<div className='rel-type'>
						<NativeSelect
						  ...
						  name="relation" >
							...
							<option value='1'>Friend of</option>
							<option value='2'>Nemesis of</option>
							<option value='3'>Romantic with</option>
							<option value='4'>Spouse of</option>
							<option value='5'>Partner with</option>
							<option value='6'>Ex-Spouse of</option>
							<option value='7'>Ex-Romantic with</option>
							<option value='8'>Parent of</option>
							<option value='9'>Child of</option>
							<option value='10'>Sibling of</option>
							<option value='11'>Grandparent of</option>
							<option value='12'>Grandchild of</option>
							<option value='13'>Colleague of</option>
							<option value='14'>Other with</option>
							<option value='15'>Relative of</option>
						</NativeSelect>
					</div>) }
					...
					<div className='rel-type'>
						<NativeSelect
						  ...
						  name="relation" >
							<option value="">Select Relation</option>
							<option value='1'>Lives in</option>
							<option value='2'>Rules</option>
							<option value='3'>Discovered</option>
							<option value='4'>Destroyed</option>
							<option value='5'>Owns</option>
							<option value='6'>Founded</option>
							<option value='7'>Visits</option>
							<option value='8'>Hails from</option>
							<option value='9'>Born in</option>
							<option value='10'>Imprisoned in</option>
						</NativeSelect>
					</div>
					) }
