...
class PlanetRelation extends React.Component {
	render() {
		  ...
		  <div className='prnt'>
			...
			{Object.keys(fields.relation.val).map(key => {
				...
				<div key={key} className='rel-prnt'>
					...
					{relation.type && relation.type === "system" && (
					...
					{relation.type && relation.type === "planet" && (
					<div className='rel-type'>
						<NativeSelect
						  disabled={!writeAccess}
						  value={relation.relation}
						  ...
						  name="relation" >
							...
							<option value='4'>Orbits</option>
							<option value='5'>Orbited by</option>
						</NativeSelect>
					</div>
					) }
					...
					{relation.type && relation.type !== "planet" && relation.type !== "system" && relation.type !== "galaxy" && relation.type !== "character" && (
					<div className='rel-type'>
						<NativeSelect
						  disabled={!writeAccess}
						  value={relation.relation}
