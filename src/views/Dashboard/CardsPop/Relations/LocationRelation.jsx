...
class LocationRelation extends React.Component {
	render() {
		  ...
		  <div className='prnt'>
			...
			{Object.keys(fields.relation.val).map(key => {
				...
				<div key={key} className='rel-prnt'>
					...
					{relation.type && relation.type !== "character" && relation.type !== "specific location" && (
					...
					{relation.type && relation.type === "specific location" && (
					<div className='rel-type'>
						<NativeSelect
						  disabled={!writeAccess}
						  value={relation.relation}
						  ...
						  name="relation" >
							<option value="">Select Relation</option>
							<option value='1'>Important to</option>
							<option value='2'>Instrumental to</option>
							<option value='3'>Nearby to</option>
							<option value='4'>Ajoining</option>
						</NativeSelect>
					</div>
					) }
