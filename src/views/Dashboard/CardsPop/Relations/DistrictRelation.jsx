...
class DistrictRelation extends React.Component {
	render() {
		  ...
		  <div className='prnt'>
			...
			{Object.keys(fields.relation.val).map(key => {
				...
				<div key={key} className='rel-prnt'>
					...
					{relation.type && relation.type !== "character" && relation.type !== "region" && (
					...
					{relation.type && relation.type === "district" && (
					<div className='rel-type'>
						<NativeSelect
						  disabled={!writeAccess}
						  value={relation.relation}
						  ...
						  name="relation" >
							<option value="">Select Relation</option>
							<option value='1'>Looks Down on</option>
							<option value='2'>Looks Up to</option>
							<option value='3'>Tense Relations with</option>
							<option value='4'>Open Hostility to</option>
							<option value='5'>Passive Hostility to</option>
						</NativeSelect>
					</div>
					) }
...
export default DistrictRelation;
