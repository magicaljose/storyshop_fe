...
class StateRelation extends React.Component {
	render() {
		  ...
		  <div className='prnt'>
			...
			{Object.keys(fields.relation.val).map(key => {
				...
				<div key={key} className='rel-prnt'>
					...
					{relation.type && relation.type !== "character" && relation.type !== "state" && (
					...
					{relation.type && relation.type === "state" && (
					<div className='rel-type'>
						<NativeSelect
						  disabled={!writeAccess}
						  value={relation.relation}
