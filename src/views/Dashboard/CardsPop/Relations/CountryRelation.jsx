...
class CountryRelation extends React.Component {
	render() {
		  ...
		  <div className='prnt'>
			...
			{Object.keys(fields.relation.val).map(key => {
				...
				<div key={key} className='rel-prnt'>
					...
					{relation.type && relation.type !== "character" && relation.type !== "country" && (
					...
					{relation.type && relation.type === "country" && (
					<div className='rel-type'>
						<NativeSelect
						  disabled={!writeAccess}
						  value={relation.relation}
...
export default CountryRelation;
