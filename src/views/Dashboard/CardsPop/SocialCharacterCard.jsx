			...
			<div className='sc-profile'>
				...
				{/*<Scrollbars className='cmn-wb-crd prt-dtl' style={{height: '280px'}} autoHide autoHideDuration={200} >*/}
					<section className='cmn-sec p1-dt'>
						...
						{
							fields && fields.alignment && fields.alignment.val && fields.alignment.val.goods && (
								<div className='cmn-itm itm10'>
									<label className='cmn-clr-sz itm-ttl'>Alignment</label>
									<div className='itm-vll'>
										{
											fields.alignment.val.goods
										}
									</div>
								</div>
							)
